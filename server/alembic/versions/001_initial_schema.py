...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("tier", sa.Enum("player", "npc_llm", "npc_rule", name="agenttier"), nullable=False, server_default="player"),
        sa.Column("status", sa.Enum("active", "sleeping", "bankrupt", "jailed", "suspended", name="agentstatus"), nullable=False, server_default="active", index=True),
    ...
    op.create_table(
        ...
        sa.Column("account_type", sa.Enum("checking", "savings", "loan", name="accounttype"), nullable=False, server_default="checking"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("open", "filled", "partially_filled", "cancelled", "expired", name="orderstatus"), nullable=False, server_default="open"),
    ...
    op.create_table(
        ...
        sa.Column("property_type", sa.Enum("land", "building", "shop", "factory", "house", name="propertytype"), nullable=False),
    ...
    op.create_table(
        "court_cases",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("case_type", sa.Enum("fraud", "breach_of_contract", "theft", "defamation", "property_dispute", "antitrust", "other", name="casetype"), nullable=False),
        ...
        sa.Column("status", sa.Enum("filed", "in_progress", "verdict_guilty", "verdict_not_guilty", "settled", "dismissed", name="casestatus"), nullable=False, server_default="filed"),
    ...
    op.create_table(
        "contracts",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("contract_type", sa.Enum("employment", "supply", "partnership", "lease", "custom", name="contracttype"), nullable=False),
        ...
        sa.Column("status", sa.Enum("proposed", "active", "completed", "breached", "terminated", name="contractstatus"), nullable=False, server_default="proposed"),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("name", sa.String(200), nullable=False),
        sa.Column("business_type", sa.Enum("shop", "factory", "farm", "bank", "restaurant", "service", "custom", name="businesstype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("tick", sa.Integer, nullable=False),
        sa.Column("category", sa.Enum("trade", "bank", "property", "court", "contract", "business", "social", "system", "crime", name="eventcategory"), nullable=False),
...
def downgrade() -> None:
    ...
    # Drop enums
    for name in [
        "eventcategory", "businesstype", "contractstatus", "contracttype",
        "casestatus", "casetype", "propertytype", "orderstatus", "orderside",
        "accounttype", "agentstatus", "agenttier",
    ]:
